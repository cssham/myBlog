			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12">
					<div class="comment-form">
                        @guest
                        <p>
                            For post a comment you need to <a style="color: blue;" href="{{ route('login') }}">login</a> first.
                        </p>
                            @else
                    ...
                    @foreach ($post->comments as $comment)
						...
						<div class="comment">
							...
							<div class="post-info">
								...
								<div class="left-area">
									<a class="avatar" href="{{ route('author.profile',$post->user->username) }}"><img src="{{ asset('public/storage/profile/'.$comment->user->image) }}" alt="Profile Image"></a>
								</div>
                    ...
                    @endforeach
                        @else
                        <div class="commnets-area">
                        <p>No one comments yet, be the first one !</p>
                    @endif
				</div><!-- col-lg-8 col-md-12 -->
