                                    ...
                                    <tbody>
                                        @foreach ($authors as $key=>$author)
                                            <tr>
                                                ...
                                                <td>{{ $author->user_favorite_post_count }}</td>
                                                <td>{{ $author->created_at->toDateString() }}</td>
                                                <td class="text-center">
                                                    <button onclick="deleteAuthor({{ $author->id }})" href="{{ route('admin.authors.destroy',$author->id) }}" class="btn btn-danger waves-effect">
