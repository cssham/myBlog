            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              Pending Posts <span class="badge bg-blue">{{ $posts->count() }}</span>
                            </h2>
                                        ...
                                        @foreach ($posts as $key=>$post)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button onclick="deletePost({{ $post->id }})" href="{{ route('admin.post.destroy',$post->id) }}" class="btn btn-danger waves-effect">
