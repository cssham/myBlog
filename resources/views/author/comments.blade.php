            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                All Comments <span class="badge bg-blue"></span>
                            </h2>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($post->comments as $comment)
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="#">
                                                                <img src="{{asset('public/storage/profile/'.$comment->user->image)  }}" width="64" height="64" alt="PP">
                                                            </a>
                                                        </div>
                                                   ...
                                                   <div class="media">
                                                        <div class="media-left">
                                                            <a target="blank" href="{{ route('post.details',$comment->post->slug) }}">
                                                                <img src="{{asset('public/storage/post/'.$comment->post->image)  }}" width="64" height="64" alt="PP">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                            <a target="blank" href="{{ route('post.details',$comment->post->slug) }}">
                                                ...
                                                <td>
                                                    <button onclick="deleteComment({{ $comment->id }})" class="btn btn-danger waves-effect">
